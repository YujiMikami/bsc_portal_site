                ...
                <div class="p-6 text-gray-900">
                    <div class="mb-6 flex">
                        <div class="container">
                            ...
                            <form action="{{ route('public.documents.update', $document->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    @if (in_array($document->file_type, ['jpg', 'jpeg']))
                                        <img src="{{ asset('storage/'.$document->file_path) }}" alt="{{ $document->title }}" width="200">
                                    @elseif ($document->file_type === 'pdf')
                                        <iframe src="{{ asset('storage/'.$document->file_path) }}" width="300" height="200"></iframe>
                                    @endif
                                </div>
