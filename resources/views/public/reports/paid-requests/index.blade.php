                ...
                <div class="bg-white shadow-sm rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="flex w-full flex-nowrap space-x-4 scrollbar-hide touch-pan-y">
                            <div class="scrollable-x flex flex-row flex-nowrap overflow-x-auto scrollbar-hide space-x-4 sm:space-x-8 sm:-my-px sm:ms-10 max-w-max">
                                                    ...
                                                    <td class="border px-4 py-2 whitespace-nowrap">
                                                        <div class="flex flex-col space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0">
                                                            ...
                                                            @can('view', $val) {{-- policyを使って制御 --}}
                                                                <a href="{{ route('public.reports.paid-requests.edit', $val->id) }}" class="text-green-600 hover:underline">編集</a>
