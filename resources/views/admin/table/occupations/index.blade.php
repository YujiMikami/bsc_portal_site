            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-start mb-4">
                        <a href="{{ route('admin.table.occupations.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded focus:outline-none focus:shadow-outline">
                            職種登録
                        </a>
                        <a href="{{ route('admin.table.occupations.importcsv') }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 mx-2 rounded focus:outline-none focus:shadow-outline">
                            CSVインポート
                        </a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        {{-- 編集ボタン --}}
                                        <a href="{{ route('admin.table.occupations.edit', $val->occupation_id) }}" class="text-green-600 hover:underline">編集</a>
                                        {{-- 削除ボタン --}}
