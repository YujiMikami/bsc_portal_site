                ...
                <div class="p-6 text-gray-900">
                    <div class="mb-6 flex">
                        ...
                        @if ($notification->start_at > now())
                            <a href="{{ route('admin.notification.edit', $notification->id) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 mr-4 rounded focus:outline-none focus:shadow-outline">編集</a>
                        @endif
                    </div>
                    <div class="mb-6">
