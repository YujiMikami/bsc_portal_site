                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div>{{ Auth::user()->employee_name }}</div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('public.reports.index')" :active="request()->routeIs('public.reports.*')">
                    申請・報告
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('public.documents.index')" :active="request()->routeIs('public.documents.*')">
                    各種資料
                </x-responsive-nav-link>
                @can('access-admin-panel')
                    <x-responsive-nav-link :href="route('admin.table.index')" :active="request()->routeIs('admin.teble.*')" style="color: red;">
                        各テーブル
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.system.index')" :active="request()->routeIs('admin.system.*')" style="color: red;">
                        ポータル管理
                    </x-responsive-nav-link>
                @endcan
