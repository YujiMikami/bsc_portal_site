...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->string('applicable_insurance_number')->comment('雇用保険番号')->nullable();
            $table->date('employee_class_updated_at')->comment('社員区分変更日')->nullable();
        ...
        Schema::create('employee_accounts', function (Blueprint $table) {
            ...
            $table->integer('department_id')->comment('部署ID')->nullable();
            $table->integer('affiliation_id')->comment('所属ID')->nullable();
            $table->integer('employee_post_id')->comment('役職')->nullable();
            $table->integer('occupation_id')->comment('職種')->nullable();
            $table->string('email')->comment('メールアドレス')->nullable();
            $table->string('password', 255);
            $table->rememberToken();
            $table->integer('portal_role');
            $table->tinyInteger('is_retired')->nullable();
            $table->timestamps();
        });
